  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-['Switzer'] overflow-x-hidden">
      ...
      <main className="flex-1 flex flex-col pt-40 md:pt-48 pb-32">
          ...
          >
            <Link href="/contact">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-10 py-5 rounded-full text-white font-bold text-xl md:text-2xl transition-all relative group"
                style={{
              ...
              >
                {/* Glow effect */}
                <div 
                  className="absolute inset-0 rounded-full blur-xl opacity-60 group-hover:opacity-100 transition-opacity bg-[#E61F93]/60" 
                  style={{ zIndex: -1 }}
                />
                Start Your Project
              </motion.button>
        ...
        {/* FAQ Section */}
        <div className="w-full mx-auto px-8 md:px-12 max-w-[1400px] mt-32 pb-16">
          <div className="mb-12">
